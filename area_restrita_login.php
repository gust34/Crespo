                            ...
                            <div class="row justify-content-center Container-1">
                                <div class="col-md-9 Form-1" style="margin:4px; padding: 40px 30px; width: 700px;">
                                    <form action="Logar.php" Method="POST">
                                        <input type="text" class="form-control" id="#" name="user" placeholder="usuário"
                                            style="background: white">
                                        <input type="password" class="form-control senha" id="#" name="senha"
                                            placeholder="senha" style="background: white">

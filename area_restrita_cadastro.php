<!Doctype html>
	<html>
        ...
        <div class="row">
            ...
            <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#modalcadastro">+Adicionar Imóvel</button></div>
        </div>
        ...
        <div class="modal fade bd-example-modal-lg" id="modalcadastro" tabindex="0" role="dialog" aria-labelledby="modalcadastro" aria-hidden="true">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="row justify-content-center mt-3">
                                        <div class="col-sm-6 text-center">
                                             ...
                                             <div class="row justify-content-center">
                                                 <div class="col-sm-3"> 
                                                     <input type="text" class="form-control" id="#" name="qsuite" placeholder="Suítes" style="width: 120%;" required> 
                                                </div>
                                                <div class="col-sm-3"> 
                                                        <input type="text" class="form-control" id="#" name="qquarto" placeholder="Quartos" style="width: 120%;" required> 
                                                </div> 
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-8 text-center">
                                                <h6 class=""> Condomínio? </h6>
                                                    <div class="row justify-content-center P-0" style="margin-left: -30%;">
                                                        <div class="col-sm-2">
                                                            <input class="form-check-input" type="radio" id="#" name="crad" value="sim" > Sim                                                        </div> 
                                                        ...
                                                        <div class="col-sm-2">
                                                                <input class="form-check-input" type="radio" id="#" name="crad" value="nao" style="margin-left: 95%;" checked> <span style="margin-left: 200%">Não</span>                                                        </div> 

    ...
    <section class="section-table">
        <div class="row">
            ...
            <div class="button col-sm-3 offset-md-6 text-center">
                <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#modalcadastro">+Adicionar
                    Imóvel</button></div>
        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Venda</td>
                            <td>Em negociação
                                <button type="submit" class="btn btn-primary" style="" data-toggle="modal" data-target="#modaleditar">Editar</button>
                                <button type="submit" class="btn btn-primary" style="" data-toggle="modal" data-target="#modaleditar">Remover</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <form name="cadastro_imovel" method="POST" action="Cadastrar.php">
                        ...
                        <div class="row justify-content-center mt-3">
                            ...
                            <div class="col-sm-6 text-center">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="#" name="areatotal" placeholder="Total"
                                            style="width: 120%;" required>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="#" name="areaconstruida"
                                            placeholder="Construída" style="width:150%;" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mt-3">
                            <div class="col-sm-6 text-center">
                                ...
                                <div class="row justify-content-center P-0">
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="#" name="qbanheiro" placeholder="WC"
                                            style="width: 120%;" required>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="#" name="qvaga" placeholder="Vagas"
                                            style="width:120%;" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center mt-3">
                            <div class="col-sm-8 text-center">
                                ...
                                <div class="row justify-content-center P-0" style="margin-left: -30%;">
                                    <div class="col-sm-2">
                                        <input class="form-check-input" type="radio" id="#" name="crad" value="sim">
                                        Sim </div>
                                    <div class="col-sm-4" style="margin-left: -6%;">
                                        <input class="form-control" type="text" id="#" name="cond" placeholder="Condomínio"
                                            style="width: 180%;"> </div>
                                    <div class="col-sm-2">
                                        <input class="form-check-input" type="radio" id="#" name="crad" value="nao"
                                            style="margin-left: 95%;" checked> <span style="margin-left: 200%">Não</span>
                                    </div>
                            ...
                            <div class="col-sm-8 text-center">
                                ...
                                <div class="row justify-content-center P-0" style="margin-left: -23%; margin-bottom: 3%;">
                                    <div class="col-sm-4 offset-md-2">
                                        <input type="text" class="form-control" id="#" name="cad1" placeholder="Característica 1"
                                            required>
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="#" name="cad6" placeholder="Característica 6"
                                            required>
                                    </div>
                                </div>
                                <div class="row justify-content-center P-0" style="margin-left: -23%; margin-bottom: 3%;">
                                    <div class="col-sm-4 offset-md-2">
                                        <input type="text" class="form-control" id="#" name="cad2" placeholder="Característica 2"
                                            required>
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="#" name="cad7" placeholder="Característica 7"
                                            required>
                                    </div>
                                </div>
                                <div class="row justify-content-center P-0" style="margin-left: -23%; margin-bottom: 3%; ">
                        ...
                        <div class="row justify-content-center mt-3">
                            <div class="col-sm-6 text-center">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="#" name="PrecoDeAluguel"
                                            placeholder="Aluguel" style="width: 120%;" required>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="#" name="PrecoDeVenda" placeholder="Venda"
                                            style="width: 120%;" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-5 text-center">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-sm-5" style="margin-left: -4%;">
                                        <input type="text" class="form-control" id="#" name="reformas" placeholder="Qtd Reformas"
                                            style="width: 120%;" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center mt-3 offset-md-2">
                            ...
                            <div class="col-sm-8 mt-3 pl-3">
                                <input type="file" name="foto" id="#" class="#" accept="image/png, image/jpeg" multiple
                                    required>
